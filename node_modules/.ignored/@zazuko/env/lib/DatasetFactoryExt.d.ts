...
declare const _default: <D extends DatasetCore<import("@rdfjs/types").Quad>>(createConstructor: (env: Environment<FormatsFactory | DataFactory | TermMapFactory>) => DatasetCtor<D>) => {
    new (): {
        dataset: FactoryMethod<D>;
        init(this: Environment<DataFactory | FormatsFactory | TermMapFactory | DatasetFactoryExt<D>>): void;
    };
};
